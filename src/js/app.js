...
async function consultarAPI() {
    try {
        // const url = `${location.origin}/api/servicios`; // Cuando se hospeda en servidores externos
        const url = "/api/servicios"; // Cuando se hospedan juntos BackEnd y ForntEnd
...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener("input", function(e) {
        ...
        if([6, 0].includes(dia)) {
            ...
            (1 === diaFestivo & 5 === mes) ||
            (16 === diaFestivo & 9 === mes) ||
            (20 === diaFestivo & 11 === mes) ||
            (1 === diaFestivo & 12 === mes) ||
            (25 === diaFestivo & 12 === mes)
        ){
            e.target.value= "";
            mostrarAlerta("No abrimos los días festivos", "error", ".formulario");
        } else {
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true) {
    // Previene que se genera más de una alerta
...
function mostrarResumen() {
    ...
    // Heading para Servicos en Resumen
